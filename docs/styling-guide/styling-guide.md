...
4. Follow the [Theme Token Rule](rules/theme-token-rule.md) so shared interface colors and measurements remain semantic and themeable.
5. Follow the [Style Placement Rule](rules/style-placement-rule.md) so reusable styling has one appropriate owner.
6. Follow the [Component State Rule](rules/component-state-rule.md) so interaction, disabled, selected, loading, and error states stay coherent.

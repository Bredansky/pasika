...
7. Configure the git hook per the [Husky Hook Rule](rules/husky-hook-rule.md) so the staged-file, typecheck, suppression-ratchet, and drift checks run before every commit.

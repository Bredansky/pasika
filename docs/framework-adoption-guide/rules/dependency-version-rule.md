...
Why: the bare versions make every install reproducible, and the pre-commit drift check fails while a dependency trails the latest release by more than one major version.

...
1. Read the Theme, Role, State, and Helper Terms in the [Glossary Reference](references/glossary-reference.md#theme-terms) so every styling term the steps below use is defined before a rule names it.

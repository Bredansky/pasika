...
void describe("The smart component's `data-testid` MUST live on an existing meaningful DOM surface. If that surface is owned by a child component, pass `data-testid` to that child and make it forward the prop; MUST NOT add an otherwise unnecessary DOM wrapper only to host `data-testid`.", () => {
  ruleTester.run("data-testid-case", dataTestIdCaseRule, {
    valid: [
      {

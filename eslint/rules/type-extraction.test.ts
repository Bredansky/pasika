    ...
    invalid: [
      {
        ...
        errors: [
          {
            message: `type "DateRange" is imported by src/features/billing/hooks/use-billing-filter.ts without the component "Invoice" that defines it. Extract it to a types/ or schemas/ folder. ${DOC}`,
          },
        ],
      },
    ],
...
void describe("Importing a type or schema alongside the component that defines it MUST NOT require extraction.", () => {
  ruleTester.run("type-extraction", typeExtractionRule, {
    valid: [
...
void describe("A type or schema declared outside a component MUST stay in its file until another file needs it without using the code in that file.", () => {
  ruleTester.run("type-extraction", typeExtractionRule, {
    valid: [
    ...
    invalid: [
      {
        ...
        errors: [
          {
            message: `type "DateRange" is imported by src/features/billing/hooks/use-date-filter.ts without using the code in this file. Extract it to a types/ or schemas/ folder. ${DOC}`,
          },
        ],
      },
    ],

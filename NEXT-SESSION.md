...
Next batch: the 8 remaining planned requirements break down as 6 docs-check (milestone 3 — @eslint/markdown), 1 zirka (eslint-disable ban), and 1 managed-file comparison (vulyk pinned source diff). Keep shineposter3000 deferred until the Pasika framework work is complete.
